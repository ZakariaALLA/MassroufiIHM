...
class CardMovimentacoesItem extends StatelessWidget {
  ...
  _dialogConfimacao(BuildContext context, double width){
    showDialog(
      ...
      builder: (context){
        return AlertDialog(
          title: Text("supprimer",textAlign: TextAlign.start,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.lightBlue[700]),),
        ...
        children: <Widget>[
          Row(
            ...
            child: Padding(
              ...
              child:mov.tipo == "r" 
              ? Icon(Icons.arrow_upward,color: Colors.green,size: width * 0.06,)
              : Icon(Icons.arrow_downward,color: Colors.red, size:width * 0.06)
            ),
          ),
          Padding(
