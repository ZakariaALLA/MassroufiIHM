...
class _CustomDialogState extends State<CustomDialog> {
  ...
  TextEditingController _controllerCateg = TextEditingController();
  ...
  void initState() {
    ...
    if (widget.mov != null) {
      ...
      //_controllerCateg.text = widget.mov.categorie;
    } else {
      edit = false;
    }
    print(" edit -> $edit");
                    ...
                    GestureDetector(
                      onTap: () {
                        if (_controllerValor.text.isNotEmpty &&
                          ...
                          Movimentacoes mov = Movimentacoes(null, null, null, null, null, null);
                          String valor;
